...
- 修复颜色选择弹层错位，靠近屏幕边缘时会自动调整位置
- 修复彩色自定义颜色按钮点击无反应；选择后立即应用到当前标注工具
- 线条、笔刷、字号和马赛克尺寸增加实时预览，继续支持无级调节
- 设置页新增“检查更新”和“下载并升级”，显示下载进度并自动校验 SHA-256
- Windows 下载完成后自动启动新版安装程序
- Apple Silicon Mac 下载完成后自动打开 DMG，并提示拖入“应用程序”
...
- Windows 10 / 11 64 位：`SnapCut-1.2.0-windows-x64.exe`
- Apple Silicon Mac（M 系列，macOS 12 或更高版本）：`SnapCut-1.2.0-macos-arm64.dmg`
