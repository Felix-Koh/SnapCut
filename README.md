...
| 系统 | 文件 | 适用设备 |
|---|---|---|
| Windows 10 / 11 | `SnapCut-1.1.0-windows-x64.exe` | 64 位 Intel / AMD 电脑 |
| macOS Apple Silicon | `SnapCut-1.1.0-macos-arm64.dmg` | macOS 12 或更高版本，M1、M2、M3、M4、M5 等 Mac |
...
推送与 `package.json` 版本一致的标签（例如 `v1.1.0`）后，GitHub Actions 会：
